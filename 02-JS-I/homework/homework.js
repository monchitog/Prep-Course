...
function combinarNombres(nombre, apellido) {
  ...
  // Tu código:
  var espacio = " ";
  var completo = nombre.concat(espacio);
  var str = completo.concat(apellido);
  return(str);
...
function obtenerSaludo(nombre) {
  ...
  var hola = "Hola ";
  var exclamación = "!";
  var str = hola.concat(nombre);
  var completo = str.concat(exclamación);
  return(completo);
